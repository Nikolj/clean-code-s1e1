...
const editTask = function () {
    ...
    const containsClass = listItem.classList.contains("todo__list-item_edit-mode");
...
const bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
    ...
    const editButton = taskListItem.querySelector("button.list-item__button-edit");
    const deleteButton = taskListItem.querySelector("button.list-item__button-delete");
